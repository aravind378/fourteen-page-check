...
<head>
    ...
    <title>DIGITAL MARKETING Fundmentals Crash Course</title>
...
<body>
    ...
    <form class="container" action="./digital-marketing-pay.php" method="POST">
        <div class="form-row">
        ...
        <input type="hidden" name="course_name" value="Digital Marketing Fundamentals Course">  
