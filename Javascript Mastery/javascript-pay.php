...
<head>
    ...
    <title>Javascript Mastery Crash Course</title>
...
<body>
    ...
    <form class="container" action="./javascript-pay.php" method="POST">
        <div class="form-row">
        ...
        <input type="hidden" name="course_name" value="Javascript Mastery Course">  
