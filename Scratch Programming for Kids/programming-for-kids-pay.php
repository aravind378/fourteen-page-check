...
<head>
    ...
    <title>Scratch Programming for Kids Crash Course</title>
...
<body>
    ...
    <form class="container" action="./programming-for-kids-pay.php" method="POST">
        <div class="form-row">
        ...
        <input type="hidden" name="course_name" value="Programming for Kids Course">  
