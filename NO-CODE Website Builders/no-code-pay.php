...
<head>
    ...
    <title>NO-CODE Website Builders Crash Course</title>
...
<body>
    ...
    <form class="container" action="./no-code-pay.php" method="POST">
        <div class="form-row">
        ...
        <input type="hidden" name="course_name" value="NO-CODE Website Builders">  
