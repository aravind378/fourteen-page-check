...
<head>
    ...
    <title>FULL STACK Fusion (MERN) Course</title>
...
<body>
    ...
    <form class="container" action="./full-stack-pay.php" method="POST">
        <div class="form-row">
        ...
        <input type="hidden" name="course_name" value="FULL STACK Fusion (MERN) Course">  
