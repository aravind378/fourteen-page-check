...
<head>
    ...
    <title>PYTHON Power-Up Crash Course</title>
...
<body>
    ...
    <form class="container" action="./python-pay.php" method="POST">
        <div class="form-row">
        ...
        <input type="hidden" name="course_name" value="Python Power-Up Course">  
