...
<head>
    ...
    <title>Excel Pro Mastery Course</title>
...
<body>
    ...
    <form class="container" action="./excel-pay.php" method="POST">
        <div class="form-row">
        ...
        <input type="hidden" name="course_name" value="Excel Pro Mastery Course">  
