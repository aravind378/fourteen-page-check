...
<head>
    ...
    <title>AI & ML Kickstart (Python Based) Crash Course</title>
...
<body>
    ...
    <form class="container" action="./php-pay.php" method="POST">
        <div class="form-row">
        ...
        <input type="hidden" name="course_name" value="AI & ML Kickstart (Python Based) Course">  
