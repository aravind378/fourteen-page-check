...
<head>
    ...
    <title>COMPUTER FUNDAMENTALS Course</title>
...
<body>
    ...
    <form class="container" action="./computer-fundamentals-pay.php" method="POST">
        <div class="form-row">
        ...
        <input type="hidden" name="course_name" value="COMPUTER FUNDAMENTALS Course">  
